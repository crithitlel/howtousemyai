...
const TAG_DEFS: TagDef[] = [
  ...
  { id: "image-generation", label: "Image generation", kind: "use-case", categories: ["Image Generation"],
  ...
  { id: "support", label: "Customer support", kind: "use-case", categories: ["Customer Support"],
    match: ["support", "customer", "chatbot", "helpdesk", "ticket", "service"] },
  { id: "hr", label: "HR & recruiting", kind: "use-case", categories: ["HR & Recruiting"],
